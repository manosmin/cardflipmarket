...
<footer className="lg:sticky lg:bottom-0 z-40 bg-white mt-auto text-xs shadow dark:bg-zinc-950 font-semibold text-zinc-400">
    <div className="w-full p-4 md:flex md:items-center md:justify-between uppercase">
      <span className="sm:text-center">The information and images presented on this site are copyrighted by <a href='https://company.wizards.com/en' target='_blank' rel='noreferrer' className='hover:underline'>Wizards of the Coast, LLC</a></span>
